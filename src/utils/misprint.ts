 ...
 *
 * Generation logic lives in shared/misprint-generator.ts (single source of truth for FE + BE).
 */

// Re-export generator functions + type from shared module
export { generateMisprintData as generatePreviewMisprintData, generateSeededMisprintData, type MisprintData } from '../../shared/misprint-generator';

/** Converts stored misprint JSON to CSS custom property style object. */
export function misprintDataToCssVars(data: import('../../shared/misprint-generator').MisprintData): Record<string, string> {
